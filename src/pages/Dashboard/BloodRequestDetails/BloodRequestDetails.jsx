...
import DetailsFormModal from "../../../components/Dashboard/Modal/DetailsFormModal";
...
const BloodRequestDetails = () => {
  ...
  const requireId = reqDetails._id
    ...
    <div className="max-w-4xl mx-auto p-6 bg-white shadow-lg rounded-xl">
      <header className="border-b pb-4 mb-6 flex justify-between items-center">
        <h1 className="text-3xl font-bold text-red-600 flex items-center">
          <span role="img" aria-label="blood drop" className="mr-2">
            🩸
          </span>
      ...
      <section className="grid md:grid-cols-2 gap-8 mb-8">
        ...
        <div>
          ...
          <DetailItem
            label="Donation Time"
            value={formatTime(reqDetails.donationTime)}
          />
        </div>
      </section>
      ...
      <section className="mt-8 pt-6 border-t">
        ...
        <DetailItem
          ...
          value={reqDetails.registererEmail}
        />
        <DetailItem
          label="Request Submitted"
          value={new Date(reqDetails.requestTime).toLocaleString()}
        />
      </section>
